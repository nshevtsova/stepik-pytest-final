...
class ProductPageLocators:
    ...
    PRODUCT_ADDED_TO_BASKET_SUCCESS_MESSAGE = (By.CSS_SELECTOR, ".alert.alert-safe.alert-noicon.alert-success:nth"
                                                                "-child(1)")
    PRODUCT_NAME_IN_PRODUCT_ADDED_TO_BASKET_SUCCESS_MESSAGE = (By.CSS_SELECTOR, ".alert.alert-safe.alert-noicon.alert"
                                                                                "-success:nth-child(1)>div>strong")
